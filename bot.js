    ...
    guild.fetchAuditLogs({
      ...
      .then(audit => {
        ...
        try {
          ...
          let log = guild.channels.find('name', 'server-log');
    ...
    role.guild.fetchAuditLogs({
      ...
      .then(audit => {
        ...
        try {
          ...
          let log = role.guild.channels.find('name', 'server-log');
          if (!log) return;
          let embed = new Discord.RichEmbed()
            .setColor('#36393e')          
...
bot.on('messageDelete', message => {
    ...
    const channel = message.guild.channels.find('name', 'server-log');
    if (!channel) return;
      ...
      re.guild.fetchAuditLogs({
        ...
        .then(audit => {
          ...
          try {
            ...
            let log = re.guild.channels.find('name', 'server-log');
            if (!log) return;
            let embed = new Discord.RichEmbed()
              .setColor('BLACK')
 ...
 bot.on("channelDelete",  dc => {
  const channel = dc.guild.channels.find("name", "server-log")
  if(channel) {
...
client.on('guildMemberAdd', member => {
  var logChannel = member.guild.channels.find(c => c.name === 'server-log');
...
client.on('guildUpdate', (oldGuild, newGuild) => {
    ...
    var logChannel = oldGuild.channels.find(c => c.name === 'server-log');
    if(!logChannel) return;
...
client.on('guildMemberUpdate', (oldMember, newMember) => {
    var logChannel = oldMember.guild.channels.find(c => c.name === 'server-log');
    if(!logChannel) return;
...
client.on('voiceStateUpdate', (voiceOld, voiceNew) => {
    ...
    var logChannel = voiceOld.guild.channels.find(c => c.name === 'server-log');
    if(!logChannel) return;
